...
# ⚡ Bolt Optimization:
# Do not call compinit manually here. The Znap plugin manager handles compinit
# and comp dumps automatically out of the box.
# Calling it manually degrades shell startup performance (redundant execution).
