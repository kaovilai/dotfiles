...
# Optimization: Removed redundant manual compinit execution.
# The Znap plugin manager automatically handles compinit and comp dumps out of the box.
# Manually calling it degrades shell startup performance and is unnecessary.
