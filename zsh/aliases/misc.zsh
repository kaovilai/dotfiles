...
alias termc='osascript -e "tell app \"Terminal\" to do script \"cd $(pwd) && happy --enable-auto-mode\""'
...
alias c='f() { osascript -e "tell app \"Terminal\" to do script \"cd $HOME/experiments/ && happy --enable-auto-mode \\\"$1\\\"\""}; f'
alias ce='cd ~/experiments/ && happy --enable-auto-mode'
alias cec='podman run --rm -it -v ~/experiments:/workspace:Z -v "$HOME/.config/claude-container:/claude" -v "$HOME/.config/gcloud:/home/node/.config/gcloud:ro" -e CLAUDE_CONFIG_DIR=/claude -e CLAUDE_CODE_USE_VERTEX -e ANTHROPIC_VERTEX_PROJECT_ID -e CLOUD_ML_REGION -e ANTHROPIC_VERTEX_BASE_URL ghcr.io/kaovilai/claude-container:latest claude'
alias ced='cd ~/experiments/ && happy --enable-auto-mode --dangerously-skip-permissions'
...
alias claude='happy --enable-auto-mode'
alias claude-dangerously='happy --enable-auto-mode --dangerously-skip-permissions'
alias claude-worktree='claude --worktree'
alias cwt='claude-worktree'
alias claude-review='f() { osascript -e "tell app \"Terminal\" to do script \"cd $HOME/experiments/ && happy --enable-auto-mode \\\"/review $1\\\"\""}; f'
