...
alias termc='osascript -e "tell app \"Terminal\" to do script \"cd $(pwd) && happy\""'
...
alias c='f() { osascript -e "tell app \"Terminal\" to do script \"cd $HOME/experiments/ && happy \\\"$1\\\"\""}; f'
alias ce='cd ~/experiments/ && happy'
...
alias ced='cd ~/experiments/ && happy --dangerously-skip-permissions'
